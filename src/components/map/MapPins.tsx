      ...
      {locations.map((location) => {
        ...
        return (
          <button
            ...
            className="absolute transform -translate-x-1/2 -translate-y-1/2 cursor-pointer group focus:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-full"
            style={{ left: `${x}%`, top: `${y}%` }}
          ...
          >
            ...
            >
              <span className="absolute inset-0 flex items-center justify-center text-[8px] sm:text-[10px]" aria-hidden="true">
                {icon}
              </span>
            </div>
          </button>
